 ...
 * temperatures go above EXTRUDER_AUTO_FAN_TEMPERATUREally turn on when their extruders'
 ...
 */
  ...
  //#define MESH_MIN_X MESH_INSET +15
  //#define MESH_MIN_Y MESH_INSET
  //#define MESH_MAX_X X_BED_SIZE - (MESH_INSET)
  //#define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET) -40
#endif
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_SCRIPT_DONE "Extra opdracht klaar"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  //#define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "Home & UBL"
  #define USER_GCODE_1 "G28\nG29 W"

  #define USER_DESC_2 "Informatie"
  #define USER_GCODE_2 "M503"

  #define USER_DESC_3 "Voorv. voor " PREHEAT_1_LABEL
  #define USER_GCODE_3 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)

  #define USER_DESC_4 "Voorv. voor " PREHEAT_2_LABEL
